...
void Pedido::tab_pedido() {
	...
	do{
		...
		if (cin.fail() || !(op >= 1 && op <=4)){
            ...
            limpiar_archivo(2);  
			ofstream archivo("data_ped.txt", ios::app);
            if (!archivo) {
...
void Pedido::print_pedido() {
    cout << "\x1B[94m" << "\n\tResumen Pedido: \n\n"<< "\x1B[m"
         << "\x1B[33m" << "Nombre del Colegio: " << "\x1B[m"<< (nombreCole ? nombreCole : "N/A") << endl
         << "\x1B[33m" << "Codigo del Colegio: " << "\x1B[m"<< codigoCole << endl
         << "\x1B[33m" << "Direccion: " << "\x1B[m"<< (direccionCole ? direccionCole : "N/A") << endl
         << "\x1B[33m" << "Email: " << "\x1B[m"<< (emailCole ? emailCole : "N/A") << endl
         << "\x1B[33m" << "Nombre del Responsable: " << "\x1B[m"<< (nombreResp ? nombreResp : "N/A") << endl
         << "\x1B[33m" << "Numero de Telefono: " << "\x1B[m"<< numTele << endl
         << "\x1B[33m" << "Codigo de RUC: " << "\x1B[m"<< codigoRUC << endl;  
}
